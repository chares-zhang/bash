...
IPS="hlg30 hlg45 hlg46 hlg47 hlg48 hlg49 hlg50 hlg53 hlg113 hlg16 hlg186"
com="cd /service/fans/app/code/Core;";
if [ "$var" != '' ]; then
BaseDir="/service/dev/hlg/fans"
for arg in $var; do
   if [ "$arg" = "lib" ];then
   	  cd ${BaseDir}/$arg
   	  git checkout dev
...
if [ "$clean" = "y" ]; then
  ...
  com=$com"echo 'clean cache';rm -rf /service/fans/var/cache/*;"
fi
com=$com"exit;";
if [ "$online" = "y" ]; then
for ip in $IPS;do 
