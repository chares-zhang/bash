...
IPS="hlg28 hlg30 hlg45 hlg46 hlg47 hlg48 hlg49 hlg50 hlg53 hlg113 hlg16 hlg186"
com="cd /service/promo/app/code/Core;";
if [ "$var" != '' ]; then
...
if [ "$clean" = "y" ]; then
  ...
  com=$com"echo 'clean cache';rm -rf /service/promo/var/cache/*;"
fi
com=$com"exit;";
if [ "$online" = "y" ]; then
for ip in $IPS;do 
